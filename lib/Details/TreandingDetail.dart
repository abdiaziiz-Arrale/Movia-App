...
class TrendingDetail extends StatefulWidget {
   TrendingDetail({required this.movie, required this.imageurl});
 final Map movie;
 final String  imageurl;
  @override
  State<TrendingDetail> createState() => _TrendingDetailState();
}

class _TrendingDetailState extends State<TrendingDetail> {
  final cast = [].obs;
